...
bool cdr_serialize_tello_msg__msg__TelloID(
  const tello_msg__msg__TelloID * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_deserialize_tello_msg__msg__TelloID(
  eprosima::fastcdr::Cdr & cdr,
  tello_msg__msg__TelloID * ros_message)
{
  // Field name: sdk_version
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_serialize_key_tello_msg__msg__TelloID(
  const tello_msg__msg__TelloID * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: sdk_version
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t get_serialized_size_key_tello_msg__msg__TelloID(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TelloID__ros_msg_type * ros_message = static_cast<const _TelloID__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t max_serialized_size_key_tello_msg__msg__TelloID(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tello_msg__msg__TelloID * ros_message = static_cast<const tello_msg__msg__TelloID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tello_msg__msg__TelloID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tello_msg__msg__TelloID * ros_message = static_cast<tello_msg__msg__TelloID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tello_msg__msg__TelloID(cdr, ros_message);
}
