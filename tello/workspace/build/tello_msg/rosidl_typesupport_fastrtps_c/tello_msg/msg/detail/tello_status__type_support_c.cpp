...
bool cdr_serialize_tello_msg__msg__TelloStatus(
  const tello_msg__msg__TelloStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_deserialize_tello_msg__msg__TelloStatus(
  eprosima::fastcdr::Cdr & cdr,
  tello_msg__msg__TelloStatus * ros_message)
{
  // Field name: acceleration
  {
  ...
  // Field name: speed
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->speed);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_serialize_key_tello_msg__msg__TelloStatus(
  const tello_msg__msg__TelloStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: acceleration
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t get_serialized_size_key_tello_msg__msg__TelloStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TelloStatus__ros_msg_type * ros_message = static_cast<const _TelloStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t max_serialized_size_key_tello_msg__msg__TelloStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tello_msg__msg__TelloStatus * ros_message = static_cast<const tello_msg__msg__TelloStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tello_msg__msg__TelloStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tello_msg__msg__TelloStatus * ros_message = static_cast<tello_msg__msg__TelloStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tello_msg__msg__TelloStatus(cdr, ros_message);
}
