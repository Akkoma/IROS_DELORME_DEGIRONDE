...
bool cdr_serialize_tello_msg__msg__TelloWifiConfig(
  const tello_msg__msg__TelloWifiConfig * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_deserialize_tello_msg__msg__TelloWifiConfig(
  eprosima::fastcdr::Cdr & cdr,
  tello_msg__msg__TelloWifiConfig * ros_message)
{
  // Field name: ssid
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
bool cdr_serialize_key_tello_msg__msg__TelloWifiConfig(
  const tello_msg__msg__TelloWifiConfig * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ssid
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t get_serialized_size_key_tello_msg__msg__TelloWifiConfig(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TelloWifiConfig__ros_msg_type * ros_message = static_cast<const _TelloWifiConfig__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tello_msg
size_t max_serialized_size_key_tello_msg__msg__TelloWifiConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const tello_msg__msg__TelloWifiConfig * ros_message = static_cast<const tello_msg__msg__TelloWifiConfig *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_tello_msg__msg__TelloWifiConfig(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  tello_msg__msg__TelloWifiConfig * ros_message = static_cast<tello_msg__msg__TelloWifiConfig *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_tello_msg__msg__TelloWifiConfig(cdr, ros_message);
}
