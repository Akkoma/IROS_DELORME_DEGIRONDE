...
static const _DroneMode_Request_type_support_symbol_names_t _DroneMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_msg, srv, DroneMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_msg, srv, DroneMode_Request)),
  }
};
...
{
  return &::tello_msg::srv::rosidl_typesupport_cpp::DroneMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_msg, srv, DroneMode_Request)() {
  return get_message_type_support_handle<tello_msg::srv::DroneMode_Request>();
}
...
static const _DroneMode_Response_type_support_symbol_names_t _DroneMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_msg, srv, DroneMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_msg, srv, DroneMode_Response)),
  }
};
...
{
  return &::tello_msg::srv::rosidl_typesupport_cpp::DroneMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_msg, srv, DroneMode_Response)() {
  return get_message_type_support_handle<tello_msg::srv::DroneMode_Response>();
}
...
typedef struct _DroneMode_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _DroneMode_Event_type_support_ids_t;

static const _DroneMode_Event_type_support_ids_t _DroneMode_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _DroneMode_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _DroneMode_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _DroneMode_Event_type_support_symbol_names_t _DroneMode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_msg, srv, DroneMode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_msg, srv, DroneMode_Event)),
  }
};

typedef struct _DroneMode_Event_type_support_data_t
{
  void * data[2];
} _DroneMode_Event_type_support_data_t;

static _DroneMode_Event_type_support_data_t _DroneMode_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _DroneMode_Event_message_typesupport_map = {
  2,
  "tello_msg",
  &_DroneMode_Event_message_typesupport_ids.typesupport_identifier[0],
  &_DroneMode_Event_message_typesupport_symbol_names.symbol_name[0],
  &_DroneMode_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t DroneMode_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_DroneMode_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::tello_msg::srv::rosidl_typesupport_cpp::DroneMode_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_msg, srv, DroneMode_Event)() {
  return get_message_type_support_handle<tello_msg::srv::DroneMode_Event>();
}
...
static const _DroneMode_type_support_symbol_names_t _DroneMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_msg, srv, DroneMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_msg, srv, DroneMode)),
  }
};
...
static const rosidl_service_type_support_t DroneMode_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tello_msg::srv::DroneMode_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tello_msg::srv::DroneMode_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tello_msg::srv::DroneMode_Event>(),
...
{
  return &::tello_msg::srv::rosidl_typesupport_cpp::DroneMode_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_msg, srv, DroneMode)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<tello_msg::srv::DroneMode>();
}
